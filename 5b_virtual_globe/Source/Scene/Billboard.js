...
define([
    ...
    function Billboard(options, billboardCollection) {
        ...
        this._timerFunction = options.timerFunction;
        this._transformationDataFunction = options.transformationDataFunction;
        this._modelRotation = options.modelRotation;
        this._bodyParts = options.bodyParts;
        this._bodyPartScales = options.bodyPartScales;
        this._adjustedBodySize = options.adjustedBodySize;
        this._headbangRotation = options.headbangRotation;
        this._imageTexture = options.imageTexture;
    ...
    Billboard.prototype.getPickId = function(context) {
        if (!defined(this._pickId)) {
            ...
            this._chartPickIds = (this._metadata || []).map(function(metadata) {
                return context.createPickId({
                    primitive : self._pickPrimitive,
