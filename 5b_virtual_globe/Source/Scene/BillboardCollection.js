...
define([
    ...
    BillboardCollection.prototype.update = function(frameState) {
        ...
        var firstBillboard = this._billboards[0];
        var billboardPosition = firstBillboard.position;
        var chartPickIds = firstBillboard._chartPickIds.map(function(pickId) {
            return pickId.key;
        });
        var selectedChartID = firstBillboard.selectedID;
        var timerFunction = firstBillboard._timerFunction;
        ...
        var uniforms = {
            ...
            animationTime: function() { return 0; },//timerFunction
            sdf_objects: function() {
                return firstBillboard._bodyParts;
            },
            image_texture: function() {
                return firstBillboard._imageTexture;
            },
            scales: function() {
                return firstBillboard._bodyPartScales;
            },
            adjusted_body_size: function() {
                return firstBillboard._adjustedBodySize;
            },
            transformation_data: firstBillboard._transformationDataFunction,
            model_rotation: function() {
                return firstBillboard._modelRotation;
            },
            headbang_rotation: function() {
                return firstBillboard._headbangRotation;
            },
        };
